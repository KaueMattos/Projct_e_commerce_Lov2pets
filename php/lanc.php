...
$consulta = $cn->query('select cd_racao, nm_racao ,vl_preco,ds_img,qt_estoque from vw_Racoes where sg_lancamento = "S"');
?>
<div class="container-fluid">
    ...
    <?php while($exibe = $consulta->fetch(PDO::FETCH_ASSOC)) { ?>
        ...
        <div><h4><b><?php echo mb_strimwidth($exibe['nm_Racao'], 0,30,'...'); ?></b></h4></div>
